...
/**
 * This is a convenience class for creating top-level windows, that
 * is "real" windows that can be resized and moved around the screen.
 *
 * @author even
 */
public class MainWindow extends JFrame
{
    ...
    /**
     * This object will be used to exit the application.
     * You can change this, e.g. to ask the user if he wants to
     * save before exit.
     */
    Action exitHandler;
     ...
     * @param a
     */
    public void setExitHandler(Action a) {
        exitHandler = a;
    }
    ...
    /**
     * This is the default exithandler. It closes, and destroys,
     * all windows. When all windows have been disposed of, the
     * program terminates.
     */
    private class SimpleExit extends AbstractAction
    {
    ...
    /**
     * Set the application to use the system look and feel, i.e.
     * it will look like a windows program in windows, a mac program
     * on a mac etc.
     */
    ...
    /**
     * This code is copied from a student project. It changes
     * some visual properties, e.g. colors and fonts.
     *
     * @throws IOException
     */
