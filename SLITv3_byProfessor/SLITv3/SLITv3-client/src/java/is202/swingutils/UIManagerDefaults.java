...
public class UIManagerDefaults implements ActionListener, ItemListener
{
    ...
    public static class SafeIcon implements Icon
    {
         ...
         */
        private JComponent getSubstitute(Class<?> clazz) throws
            ...
            try {
                ...
                ((AbstractButton) standInComponent).setModel(
                        new DefaultButtonModel());
            }
            return standInComponent;
        }

        private Class<?> getClass(ClassCastException e) throws
    ...
    class SampleRenderer extends JLabel implements TableCellRenderer
    {
        ...
        public Component getTableCellRendererComponent(
                JTable table, Object sample, boolean isSelected,
...
//				System.out.println(e.getStackTrace()[0]);
    ...
    class ChangeLookAndFeelAction extends AbstractAction
    {
        ...
        protected ChangeLookAndFeelAction(UIManagerDefaults defaults, String laf,
                                          String name) {
